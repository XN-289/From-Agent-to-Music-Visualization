...
import type { StageAppearanceSnapshot, StageVisualConfig } from '../types';
...
export type SettingsUiState = {
    ...
    applyStageAppearanceOverride: (config: StageVisualConfig) => void;
    restoreStageAppearanceSnapshot: (snapshot: StageAppearanceSnapshot) => void;
...
export const useSettingsUiStore = create<SettingsUiState>((set, get) => ({
    ...
    applyStageAppearanceOverride: (config) => {
        set({
            ...
            disableVisualizerGeometricBackground: config.disableVisualizerGeometricBackground,
            disableVisualizerVignette: config.disableVisualizerVignette,
        });
    },
    restoreStageAppearanceSnapshot: (snapshot) => {
        set({
            visualizerMode: snapshot.visualizerMode,
            visualizerBackgroundMode: snapshot.visualizerBackgroundMode,
            backgroundOpacity: snapshot.backgroundOpacity,
            visualizerOpacity: snapshot.visualizerOpacity,
            useCoverColorBg: snapshot.useCoverColorBg,
            disableVisualizerGeometricBackground: snapshot.disableVisualizerGeometricBackground,
            disableVisualizerVignette: snapshot.disableVisualizerVignette,
        });
    },
